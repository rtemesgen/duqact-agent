...
export const api = {
  ...
  recordTransaction: (item: { accountId: number; walletId?: number; transactionType: string; amount: number; clientPhone: string; clientName: string }) => request<MnoTransaction>('/mno-transactions', { method: 'POST', body: body(item) }),
